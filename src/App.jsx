  ...
  async function handleDocxUpload(file) {
    ...
    try {
      ...
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        method: "POST",
        headers: { "Content-Type": "application/json", "x-api-key": "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", "anthropic-version": "2023-06-01", "anthropic-dangerous-direct-browser-access": "true" },
        body: JSON.stringify({
